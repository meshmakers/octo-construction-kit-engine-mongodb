        ...
        int? take)
    {
        ...
        var aggregate = _databaseContext.GetRtDatabaseCollection<RtEntity>(_originCkTypeId).Aggregate(session)
            ...
            .GraphLookup<RtAssociation, BsonValue, BsonValue, BsonValue, TTargetEntity, TTargetEntity[], BsonDocument>(
                from: _databaseContext.RtDatabaseAssociations.GetMongoCollection(),
            ...
            .Lookup<BsonDocument, TTargetEntity, TTargetEntity, IEnumerable<TTargetEntity>, BsonDocument>(
                foreignCollection: _databaseContext.GetRtDatabaseCollection<TTargetEntity>(_targetCkTypeId).GetMongoCollection(),
