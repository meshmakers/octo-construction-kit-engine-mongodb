...
public class ResourceStore : IOctoResourceStore
{
    ...
    public ResourceStore(ITenantRepository tenantRepository, IMapper mapper)
    {
    ...
    public async Task<RtApiResource> GetOrCreateApiResourceAsync(ApiResource apiResource)
    {
