...
/// falls <b>at or before</b> the high-water mark that dependent rollups have already consumed is a
/// correction / late value, not a forward append, and therefore makes those dependents stale. Given
...
{
    /// <summary>
    /// Returns <c>true</c> and the covering dirty window when at least one timestamp is at/before
    /// <paramref name="consumedWatermark"/>. The window spans the earliest..latest retroactive
